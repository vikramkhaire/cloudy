...
def cloudy_params_defaults(uvb_Q = 18, uvb_scale = 1, log_hden = [-4, -4, 1], hden_vary=True, uvb = 'KS18', z=0.2,
    ...
    ions = ["H", "H+",
            ...
            "Si", "Si+", "Si+2", "Si+3", "Si+4", "Si+5", "Si+6", "Si+7","Si+8", "Si+9", "Si+10","Si+11", "Si+12", "Si+13"]
...
input_file = '/home/vikram/cloudy_run/oxygen/full_NH133_Q18.in'
cloudy_run_path_and_file =[cloudy_path, input_file]

# write input file and run cloudy
ions, params = cloudy_params_defaults(uvb_Q=uvb_Q, stop_NHI = 13.3,  log_hden= [-5, -2, 0.1],  remove_dot_out_file = False)
...
uvb_Q=18
cloudy_path = '/home/vikram/c17.02'
input_file = '/home/vikram/cloudy_run/oxygen/highT/full_NH134_T55.in'
cloudy_run_path_and_file =[cloudy_path, input_file]

# write input file and run cloudy
ions, params = cloudy_params_defaults(uvb_Q=uvb_Q, uvb_scale= 1e-9, T= 10**5.5, stop_NHI = 13.4,  log_hden= [-5, -2, 0.1],  remove_dot_out_file = False)
write_input_and_run(cloudy_run_path_and_file, *ions, **params)
"""
