...
# setting the figure
    ...
    hden_t=hden.T
    dat=np.abs(np.log10(tab1)-np.log10(tab2))
    dataf=dat
    ...
    ax = sb.heatmap(read, xticklabels=1,cmap=cmap, cbar_kws={'label': 'Log ( column Uni) - Log (column Bi) -directional incident'})
...
"""
example:
from plot2 import make_plot as mk
